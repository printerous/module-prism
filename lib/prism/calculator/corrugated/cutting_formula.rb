module Prism
  class Calculator::Corrugated::CuttingFormula
    ...
    def component_manual
      @component_manual ||= Prism::Component.find_by(code: 'CUTTING_CORRUGATED_MANUAL')
    end
    ...
    def component_auto
      @component_auto ||= Prism::Component.find_by(code: 'CUTTING_CORRUGATED_AUTO')
    end
    ...
    def cutting_length
      ...
      @cutting_length ||= begin
        ...
        if product_price[:material_length_used] > Prism::Calculator::Corrugated::MaterialFormula::MAX_LENGTH
